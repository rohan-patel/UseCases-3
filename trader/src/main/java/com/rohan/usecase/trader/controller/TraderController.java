...
public class TraderController {
	...
	// Trader _trader = repository.save(new Trader(trader.getName(),
	// trader.getEmail(), trader.getBalance(),
	...
	public ResponseEntity<Trader> updateName(@RequestBody Map<String, String> payload) {
		...
		if (trader == null) {
			throw new EntityNotFoundException("Trader with email " + trader.getEmail() + " not found in the database");
		}
